//package com.line.common.cache.redis.serializer;
//
...
//        byte[] binary = new ObjectMapper().convertValue(base64, byte[].class);
//        System.out.println(new String(binary));
////编码
//        String str = "Man is distinguished, not only by his reason, but by this";
//        String base = new ObjectMapper().convertValue(str.getBytes(), String.class);
